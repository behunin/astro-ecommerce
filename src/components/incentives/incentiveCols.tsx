  ...
  return (
    <div class="grid grid-flow-row md:grid-flow-col mt-5">
      <div class="flex items-center gap-3">
        <i class="fas fa-shipping-fast text-3xl text-blue-600 me-4"></i>
        <div>
      ...
      <div class="flex items-center gap-3">
        <i class="fas fa-user text-3xl text-blue-600 m-4"></i>
        <div>
      ...
      <div class="flex items-center gap-3">
        <i class="fas fa-sync-alt text-3xl text-blue-600 m-4"></i>
        <div>
